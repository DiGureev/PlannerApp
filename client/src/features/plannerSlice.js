...
// const BASE_URL = 'http://localhost:3001/api/planner';
...
export const delAllDay = createAsyncThunk('planner/deleteday', async(date)=>{
    const response = await axios.delete(`/all/${date}`)
    return response.data
})
